...
export default function ContactPage() {
  return (
    <div className="relative min-h-screen bg-black flex flex-col font-montserrat">
      ...
      <div className="pointer-events-none absolute right-0 top-4 w-full h-80 z-0 flex justify-end">
      ...
      <main className="flex-1 min-h-screen flex flex-col md:flex-row items-stretch justify-between max-w-screen-2xl mx-auto w-full px-4 md:px-12 pt-32 pb-20 relative z-10">
        ...
        <div className="flex-1 flex flex-col justify-center">
          <h1 className="text-white text-[clamp(2.5rem,10vw,7.5rem)] leading-[0.95] font-light tracking-tight whitespace-pre-line" style={{fontFamily: 'Inter, Arial, Helvetica, sans-serif'}}>
            {`YOU'RE NEVER\nFAR FROM\nOUTPOST`}<span className="align-super text-[0.5em] ml-2">©</span>
          </h1>
        </div>
        ...
        <div className="w-full md:w-[420px] flex flex-col justify-center gap-12 text-white text-sm md:text-base font-medium z-10 md:items-end md:text-right md:ml-auto">
          <div>
            ...
            <div className="font-bold text-white">INFO@OUTPOST.DESIGN<br />+44 (0) 126 028 5815</div>
          </div>
          <div>
            <div className="uppercase text-xs text-neutral-400 mb-2 tracking-widest">Our address</div>
            <div className="font-bold text-white">THE COLONY<br />ALTRINCHAM ROAD<br />WILMSLOW, CHESHIRE<br />UNITED KINGDOM<br />SK9 4LY</div>
          </div>
          <div>
            ...
            <div className="font-bold text-white flex flex-col gap-1 md:items-end md:text-right">
              <a href="#" className="hover:underline">X<span className="ml-1">↗</span></a>
              ...
              <a href="#" className="hover:underline">Behance<span className="ml-1">↗</span></a>
              <a href="#" className="hover:underline">Dribbble<span className="ml-1">↗</span></a>
            </div>
          </div>
        </div>
      </main>
