...
const Header = ({ onEnquire }: HeaderProps) => {
  ...
  return (
    <>
      ...
      {/* Get Started Modal */}
      {showGetStartedModal && (
        <div className="fixed top-0 left-0 z-[99999] w-full h-full bg-black/70 font-montserrat flex items-start justify-start md:items-start md:justify-end">
          <div 
            className="bg-gradient-to-r from-purple-600 to-pink-500 rounded-2xl shadow-2xl p-6 w-full max-w-[90%] sm:max-w-md md:max-w-lg m-4 md:mr-8 md:mt-20 animate-fadeIn flex flex-col items-center font-montserrat"
          ...
          >
            ...
            {!userType && (
              <>
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full justify-center font-montserrat" style={{ fontFamily: 'Montserrat, Helvetica, sans-serif' }}>
                  <button
                    className="flex-1 bg-white bg-opacity-20 text-black font-bold py-2 sm:py-3 rounded-xl text-base sm:text-lg transition-all duration-300 hover:scale-105 border border-white cursor-pointer font-montserrat"
                    style={{ fontFamily: 'Montserrat, Helvetica, sans-serif' }}
            ...
            {userType === 'realtor' && (
              <form className="flex flex-col gap-3 sm:gap-4 mt-4 w-full items-center justify-center font-montserrat" style={{ fontFamily: 'Montserrat, Helvetica, sans-serif' }}>
                <h3 className="text-lg sm:text-xl font-semibold text-white mb-2 text-center font-montserrat" style={{ fontFamily: 'Montserrat, Helvetica, sans-serif' }}>
                  Realtor Inquiry
                </h3>
                <input className="px-3 sm:px-4 py-2 rounded bg-white bg-opacity-20 text-black border border-white w-full font-montserrat" style={{ fontFamily: 'Montserrat, Helvetica, sans-serif' }} placeholder="Your Name" />
                <input className="px-3 sm:px-4 py-2 rounded bg-white bg-opacity-20 text-black border border-white w-full font-montserrat" style={{ fontFamily: 'Montserrat, Helvetica, sans-serif' }} placeholder="Email" type="email" />
                <div className="flex w-full gap-2 font-montserrat" style={{ fontFamily: 'Montserrat, Helvetica, sans-serif' }}>
                  ...
                  <input className="flex-1 px-3 sm:px-4 py-2 rounded bg-white bg-opacity-20 text-black border border-white font-montserrat" style={{ fontFamily: 'Montserrat, Helvetica, sans-serif' }} placeholder="Phone Number" type="tel" />
                </div>
                <input className="px-3 sm:px-4 py-2 rounded bg-white bg-opacity-20 text-black border border-white w-full font-montserrat" style={{ fontFamily: 'Montserrat, Helvetica, sans-serif' }} placeholder="Agency/Company" />
                <button className="w-full bg-white bg-opacity-30 text-purple-700 font-bold py-2 rounded-xl mt-2 cursor-pointer font-montserrat" style={{ fontFamily: 'Montserrat, Helvetica, sans-serif' }}>
                  Submit
                </button>
                <button type="button" className="text-sm text-white mt-2 cursor-pointer font-montserrat" style={{ fontFamily: 'Montserrat, Helvetica, sans-serif' }} onClick={() => setUserType(null)}>
                  Back
                </button>
              </form>
            )}
            {userType === 'buyer' && (
              <form className="flex flex-col gap-3 sm:gap-4 mt-4 w-full items-center justify-center font-montserrat" style={{ fontFamily: 'Montserrat, Helvetica, sans-serif' }}>
                ...
                <input className="px-3 sm:px-4 py-2 rounded bg-white bg-opacity-20 text-black border border-white w-full font-montserrat" style={{ fontFamily: 'Montserrat, Helvetica, sans-serif' }} placeholder="What are you looking for?" />
                <button className="w-full bg-white bg-opacity-30 text-purple-700 font-bold py-2 rounded-xl mt-2 cursor-pointer font-montserrat" style={{ fontFamily: 'Montserrat, Helvetica, sans-serif' }}>
                  Submit
                </button>
                <button type="button" className="text-sm text-white mt-2 cursor-pointer font-montserrat" style={{ fontFamily: 'Montserrat, Helvetica, sans-serif' }} onClick={() => setUserType(null)}>
